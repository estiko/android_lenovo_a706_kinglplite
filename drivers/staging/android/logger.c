...
DEFINE_LOGGER_DEVICE(log_main, LOGGER_LOG_MAIN, 5*1024)
DEFINE_LOGGER_DEVICE(log_events, LOGGER_LOG_EVENTS, 5*1024)
DEFINE_LOGGER_DEVICE(log_radio, LOGGER_LOG_RADIO, 5*1024)
DEFINE_LOGGER_DEVICE(log_system, LOGGER_LOG_SYSTEM, 5*1024)
